...
pylint --load-plugins=pylint.extensions.check_elif,pylint.extensions.docstyle,pylint.extensions.emptystring,pylint.extensions.overlapping_exceptions \
       ...
       --disable=blacklisted-name,invalid-name,missing-class-docstring,missing-function-docstring,missing-module-docstring,design,too-many-lines,old-division,no-absolute-import,input-builtin,too-many-nested-blocks \
       --max-line-length=120 \
       --init-import=yes \
       ./**/*.py ./**/*.pyw ./**/*.py3 ./**/*.pyi
